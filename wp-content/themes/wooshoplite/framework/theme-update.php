...
define( 'NOTIFIER_THEME_LATEST_VERSION', '2-1-8' ); // Latest version of the theme
...
function get_latest_theme_version($interval) {
	...
	$db_cache_field = 'notifier-cache-'.NOTIFIER_THEME_FOLDER_NAME.'-'.NOTIFIER_THEME_LATEST_VERSION;
	$db_cache_field_last_updated = 'notifier-cache-last-updated-'.NOTIFIER_THEME_FOLDER_NAME.'-'.NOTIFIER_THEME_LATEST_VERSION;
