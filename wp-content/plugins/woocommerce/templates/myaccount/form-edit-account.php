...
<div class="profile-form">
	<form class="profile-form" action="" method="post">
		...
		<p class="form-row form-row-first tooltip-qtip">
			<label for="password_1"><?php _e( 'Password', 'woocommerce' ); ?></label>
			<input type="password" class="input-text masterTooltip" name="password_1" id="password_1" />
		</p>
		<p class="form-row form-row-last tooltip-qtip">
		...
		<p class="save-address">
			<input type="submit" class="my-button" name="save_account_details" value="<?php _e( 'Save changes', 'woocommerce' ); ?>" />
		</p>
